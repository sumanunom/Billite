...
function pdf_create(
    ...
    if ($isInvoice) {
        ...
        $mpdf->SetHTMLFooter('<div id="footer"><p style="text-align:center;">Powered By <a href="https://billite.in/?ref=pdffooter" style="text-decoration:none;" target="_blank">Billite</a></div>');
    }

    // Set the footer if voucher is quote and if set in settings
    if (strpos($filename, trans('quote')) !== false) {
        $mpdf->setAutoBottomMargin = 'stretch';
        $mpdf->SetHTMLFooter('<div id="footer"><p style="text-align:center;">Powered By <a href="https://billite.in/?ref=pdffooter" style="text-decoration:none;" target="_blank">Billite</a></div>');
    }
