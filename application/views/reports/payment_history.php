...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/<?php echo get_setting('system_theme', 'billite'); ?>/css/reports.css" type="text/css">
</head>
<body>
...
<table>
    <tr>
        ...
        <th class="amount"><?php echo trans('tds_deducted'); ?></th>
        <th class="amount"><?php echo trans('bank_charges'); ?></th>
    ...
    foreach ($results as $result) {
        ...
        <tr>
            ...
            <td><?php echo format_currency($result->tds_deducted);?></td>
            <td><?php echo format_currency($result->bank_charges);?></td>
