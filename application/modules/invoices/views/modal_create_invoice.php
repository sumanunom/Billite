...
<div id="create-invoice" class="modal modal-lg"
    ...
    <form class="modal-content" id="hi">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="$('#modal-placeholder').hide();" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
            <div class="btn-group">
                ...
                <button class="btn btn-danger" type="button" data-dismiss="modal" onclick="$('#modal-placeholder').hide();">
