...
class Mdl_Setup extends CI_Model
{
    ...
    private function install_default_settings()
    {
        ...
        $default_settings = array(
            ...
            'pdf_invoice_template' => 'Billite',
            'pdf_invoice_template_paid' => 'Billite - paid',
            'pdf_invoice_template_overdue' => 'Billite - overdue',
            'pdf_quote_template' => 'Billite',
            'public_invoice_template' => 'Billite_Web',
            'public_quote_template' => 'Billite_Web',
            'disable_sidebar' => 1,
        );
