...
class Mdl_Quotes extends Response_Model
{
    ...
    {
        $this->filter_where_in('quote_status_id', array(1, 2, 3, 4, 5));
        return $this;
    }
...
// -------------- Category data get from setting table----------------

//     public function setting_value()
// {
//     $query = $this->db->query(" SELECT * FROM ip_settings WHERE setting_key = 'category' ");
...
{
    $query = $this->db->query(" SELECT setting_value, REPLACE(`setting_value`,',','')  AS new_col
        FROM ip_settings 
...
//  public function approve($currenttime)
// {
//     $this->db->query(" 
//                         UPDATE ip_quotes 
//                         SET quote_status_approved = $currenttime
//                         WHERE quote_status_id = 4 
//                     ");
// }
