...
<div id="create-quote" class="modal modal-lg" role="dialog" aria-labelledby="modal_create_quote" aria-hidden="true">
    ...
    <form class="modal-content" id="hi">
        <div class="modal-header">
            ...
            <button type="button" class="btn-close" onclick="$('#modal-placeholder').hide();" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
            <div class="btn-group">
                ...
                <button class="btn btn-danger" type="button" onclick="$('#modal-placeholder').hide();">
