...
<div id="modal_change_client" class="modal modal-lg" role="dialog" aria-labelledby="modal_change_client" aria-hidden="true">
    <form class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><?php _trans('change_client'); ?></h5>
