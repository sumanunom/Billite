...
<br>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5 quote-total">
            <div class="invo-cal">
                <div>Subtotal</div> 
                <div><?php echo format_currency($quote->quote_item_subtotal); ?></div>
            </div>
            <div class="invo-cal">
                <div>Item Tax </div>
                <div><?php echo format_currency($quote->quote_item_tax_total); ?></div>
            </div>
            <div class="invo-cal">
                <div>Invoice Tax </div> 
                <div>
            ...
            <hr class="invo-hr">
             <div class="invo-cal">
                <div>Total</div>
                <div><?php echo format_currency($quote->quote_total); ?></div>
            </div>
        </div>
  ...
  <div class="col-lg-3 col-md-3 col-sm-3 invo_client_detail"> 
    ...
    <div class="row invo-due-amt">
        <div class="invo-amt-due">
            <h4>Estimated Amount(<?php echo get_setting('currency_symbol', '', true); ?>)</h4>
            <h3><?php echo format_currency($quote->quote_item_subtotal); ?></h3>
            <p> 
                <?php 
