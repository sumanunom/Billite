...
<script>
    $(function () {
            ...
            $.post("<?php echo site_url('guest/invoices/save'); ?>", {
                ...
                function (data) {
                    ...
                    if (response.success === 1) {
                        window.location = "<?php echo site_url('guest/invoices/invoice_view'); ?>/" + <?php echo $invoice_id; ?>;
                    } else {
        ...
        $(document).on('click', '.btn_delete_item', function () {
            ...
            $.post("<?php echo site_url('guest/invoices/invo_delete_item/' . $invoice->invoice_id); ?>", {
                    'item_id': item_id,
                },
                function (data) {
...
<div id="invo">
    ...
    <div id="invoice_form ">
        <div class="invoice invoice-view-style">
           ...
           <!--  <div class="row">
            ...
            <?php $this->layout->load_view('guest/invoices_item_table'); ?>

            <?php if ($custom_fields): ?>
                <div class="row">
                    <div class="col-lg-9 col-xs-12 col-md-8 invoice_custom_field">
                        <div class="row">
