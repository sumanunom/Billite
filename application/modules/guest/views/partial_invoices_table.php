...
<div class="table-responsive">
    <table class="billite-table table table-hover table-striped no-margin" id="datatable5">
        ...
        <tr>
            ...
            <th class="pay"><?php _trans('amount'); ?></th>
            <th class="pay"><?php _trans('balance'); ?></th>
            ...
            <tr>
                ...
                <td>
                    <div class="options btn-group btn-group-sm">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo site_url('guest/invoices/invoice_view/' . $invoice->invoice_id); ?>"
