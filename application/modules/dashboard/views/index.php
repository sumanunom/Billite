...
<link href="<?php echo base_url(); ?>assets/core/vendors/mdi/css/materialdesignicons.min.css?v=<?echo rand();?>" rel="stylesheet">
                      ...
                      <div class="dashcol-sm-12 pt-4">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div class="statistics-color">
                            ...
                            <p class="text-danger d-flex ptext"><i class="mdi mdi-menu-down"></i><span>-0.5%</span></p>
                          </div>
                          <div class="statistics-color">
                            <p class="statistics-title ptext">Invoices Sent this month</p>
                            <h3 class="rate-percentage">7,682</h3>
                            <p class="text-success d-flex ptext"><i class="mdi mdi-menu-up"></i><span>+0.1%</span></p>
                          </div>
                          <div class="statistics-color">
                            <p class="statistics-title ptext">Payments in this month</p>
                            <h3 class="rate-percentage">68.8</h3>
                            <p class="text-danger d-flex ptext"><i class="mdi mdi-menu-down"></i><span>68.8</span></p>
                          </div>
                          <!--<div class="d-none d-md-block"> -->
                            <div class="statistics-color">
                            <p class="statistics-title ptext">Average Billing Value</p>
                            <h3 class="rate-percentage">2m:35s</h3>
                            <p class="text-success d-flex ptext"><i class="mdi mdi-menu-down"></i><span>+0.8%</span></p>
                          </div>
                          <div class="statistics-color">
                              ...
                              <div class="card-body dash-body p-4">
                                <div class="d-sm-flex justify-content-between align-items-start recent-invoice">
                                  <div>
                                   ...
                                   <p class="card-subtitle card-subtitle-dash ptext">You have 50+ unpaid invoices.</p>
                                  </div>
                                  <div>
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <?php foreach ($invo as $invoice){
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <h6><?php echo format_currency($invoice->invoice_total); ?></h6>
                                      </td>
                                      <td>
                                          <?php
                                  ...
                                  <div class="wrapper w-100">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                      <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 text-small text-muted ptext me-4"><?php echo $q->quote_date_created; ?></p>
                                        <p class="mb-0 text-small text-muted ptext"><?php echo format_currency( $q->quote_total); ?></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body dash-body activites">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                  ...
                                  <p class="mb-0 ptext">20 finished, 5 remaining</p>
                                </div>
                                <ul class="bullet-line-list" style="list-style: none !important;">
                                  <li>
                                    <div class="d-flex justify-content-between">
                                      <div><span class="text-light-green activites-text">You sent an invoice</span> to Client A</div>
                                      <p class="ptext">Just now</p>
                                    </div>
                                  </li>
                                  <li>
                                    <div class="d-flex justify-content-between">
                                      <div><span class="text-light-green activites-text">You sent an invoice</span> to Client B</div>
                                      <p class="ptext">1h</p>
                                    </div>
                                  </li>
                                  <li>
                                    <div class="d-flex justify-content-between">
                                      <div><span class="text-light-green activites-text">Client G has paid for</span> Invoice 00042</div>
                                      <p class="ptext">1h</p>
                                    </div>
                                  </li>
                                  <li>
                                    <div class="d-flex justify-content-between">
                                      <div><span class="text-light-green activites-text">Client A has paid for</span> Invoice 00020</div>
                                      <p class="ptext">1h</p>
                                    </div>
                                  </li>
                                  <li>
                                    <div class="d-flex justify-content-between">
                                      <div><span class="text-light-green activites-text">Client C has paid for</span> Invoice 00040</div>
                                      <p class="ptext">1h</p>
                                    </div>
                                  </li>
                                </ul>
                                  ...
                                  <div class="dashcol-lg-12">
                                    ...
                                    <?php foreach($top_clients as $tc) { ?>
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        ...
                                        <?php foreach($invo_status as $invo){
                                          echo format_currency($invo->total);
                                        }
                                        ?>
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        ...
                                        <div class="text-muted text-small">
                                        <?php foreach($invo_status1 as $invo1){
                                          echo format_currency($invo1->total);
                                        }
                                        ?>
                                        </div>
                                      </div>
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        ...
                                        <div class="text-muted text-small">
                                        <?php foreach($invo_status2 as $invo2){
                                          echo format_currency($invo2->total);
                                        }
                                        ?>
                                        </div>
                                      </div>
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        ...
                                        <div class="text-muted text-small">
                                        <?php foreach($invo_status3 as $invo3){
                                          echo format_currency($invo3->total);
                                        }
                                        ?>
                                        </div>
                                      </div>
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        ...
                                        <div class="text-muted text-small">
                                        <?php foreach($invo_status4 as $invo4){
                                          echo format_currency($invo4->total);
                                        }
                                        ?>
                                        </div>
                                      </div>
