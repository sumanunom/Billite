...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/<?php echo get_setting('system_theme', 'billite'); ?>/css/style.css"
          rel="stylesheet">
  ...
  <div class="row login-session">
    <div class="container-fluid main-section">
        ...
        <form class="forms validate-form" method="post" action="<?php echo site_url($this->uri->uri_string()); ?>">
          ...
          <h2 class="pb-3 fw-bold">Password Reset</h2>
              <div class="col login-email">
			    
             <div class="col form-group">
		<!-- <label for="email" class="hidden"><?php _trans('email'); ?></label> -->
		<input type="text" name="email" placeholder="<?php _trans('email'); ?>" id="email" class="form-control"
                 required autofocus>
