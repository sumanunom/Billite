...
class Mdl_Payments extends Response_Model
{
    ...
    public function validation_rules()
    {
        return array(
            ...
            'tds_deducted' => array(
                'field' => 'tds_deducted',
                'label' => trans('tds_deducted')
            ),
            'bank_charges' => array(
                'field' => 'bank_charges',
                'label' => trans('bank_charges')
            ),
        );
    }
    ...
    public function validate_payment_amount($amount)
    {
        ...
        if ($payment_id) {
            ...
            $invoice_balance = $invoice_balance + (float)$payment->payment_amount + (float)$payment->tds_deducted + (float)$payment->bank_charges ;
        }
