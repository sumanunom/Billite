...
<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
 ...
 <a id="c_date"  href="<?php echo site_url('reports/sale_date_custom_year'); ?>" class="dropdown-item">Custom Year</a>
</div>
</div>
...
<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
 ...
 <a id="custom-year" href="<?php echo site_url('reports/sale_date_custom_year'); ?>" class="dropdown-item">Custom Year</a>
</div>
</div>
