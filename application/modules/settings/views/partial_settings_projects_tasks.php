                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[projects_enabled]">
                                <?php _trans('enable_projects'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[default_hourly_rate]">
                                <?php _trans('default_hourly_rate'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
