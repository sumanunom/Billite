    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2 settings-panels">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[default_invoice_group]">
                                <?php _trans('default_invoice_group'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[default_invoice_terms]">
                                <?php _trans('default_terms'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[invoice_default_payment_method]">
                                <?php _trans('default_payment_method'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[invoices_due_after]">
                                <?php _trans('invoices_due_after'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[automatic_email_on_recur]">
                                <?php _trans('automatic_email_on_recur'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <!--<div class="form-group">
                            <label for="settings[generate_invoice_number_for_draft]">
                                <?php _trans('generate_invoice_number_for_draft'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[mark_invoices_sent_pdf]">
                                <?php _trans('mark_invoices_sent_pdf'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[invoice_pre_password]">
                                <?php _trans('invoice_pre_password'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <!--<div class="form-group">
                            <label for="settings[include_zugferd]">
                                <?php _trans('invoice_pdf_include_zugferd'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[pdf_watermark]">
                                <?php _trans('pdf_watermark'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label><?php _trans('invoice_logo'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[pdf_invoice_template]">
                                <?php _trans('default_pdf_template'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[pdf_invoice_template_paid]">
                                <?php _trans('pdf_template_paid'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[pdf_invoice_template_overdue]">
                                <?php _trans('pdf_template_overdue'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[public_invoice_template]">
                                <?php _trans('default_public_template'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[email_invoice_template]">
                                <?php _trans('default_email_template'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[email_invoice_template_paid]">
                                <?php _trans('email_template_paid'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[email_invoice_template_overdue]">
                                <?php _trans('email_template_overdue'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                ...
                <!--                <?php _trans('pdf_invoice_footer'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>-->
                <!--            </label>-->
