                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[email_pdf_attachment]">
                                <?php _trans('email_pdf_attachment'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="email_send_method">
                                <?php _trans('email_send_method'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div id="div-smtp-settings">
                            ...
                            <div class="form-group">
                                <label for="settings[smtp_server_address]">
                                    <?php _trans('smtp_server_address'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="settings[smtp_mail_from]">
                                    <?php _trans('smtp_mail_from'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="settings[smtp_authentication]">
                                    <?php _trans('smtp_requires_authentication'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="settings[smtp_username]">
                                    <?php _trans('smtp_username'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="smtp_password">
                                    <?php _trans('smtp_password'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
                            ...
                            <div class="form-group">
                                <div>
                                    <label for="settings[smtp_port]">
                                        <?php _trans('smtp_port'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                    </label>
                            ...
                            <div class="form-group">
                                <label for="settings[smtp_security]">
                                    <?php _trans('smtp_security'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
                            ...
                            <div class="form-group">
                                <label for="settings[smtp_verify_certs]">
                                    <?php _trans('smtp_verify_certs'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                                </label>
