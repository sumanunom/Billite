                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[default_quote_group]">
                                <?php _trans('default_quote_group'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[default_quote_notes]">
                                <?php _trans('default_notes'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[quotes_expire_after]">
                                <?php _trans('quotes_expire_after'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <!--<div class="form-group">
                            <label for="settings[generate_quote_number_for_draft]">
                                <?php _trans('generate_quote_number_for_draft'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[mark_quotes_sent_pdf]">
                                <?php _trans('mark_quotes_sent_pdf'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="settings[quote_pre_password]">
                                <?php _trans('quote_pre_password'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>
                            </label>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <!--        <?php _trans('pdf_quote_footer'); ?><span class="tooltip9 fw-normal"><i class="fa-solid fa-info"></i><span class="tooltip9-text">ToolTip</span></span>-->
                        <!--    </label>-->
