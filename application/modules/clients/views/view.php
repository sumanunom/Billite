...
<ul id="submenu" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li><a class="text-decoration-none" data-toggle="tab" href="#clientQuotes"><?php _trans('quotes'); ?></a></li>
    <li><a class="text-decoration-none" data-toggle="tab" href="#clientInvoices"><?php _trans('invoices'); ?></a></li>
    <li><a class="text-decoration-none" data-toggle="tab" href="#clientPayments"><?php _trans('payments'); ?></a></li>
</ul>

<div id="content" class="tabbable tabs-below no-padding" style="height:78vh; overflow-y:scroll">
