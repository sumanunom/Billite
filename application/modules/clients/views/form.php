        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                         ...
                         <!--  <div class="form-group">
                            ...
                            <input id="currency" name="currency" type="text" class="form-control" required
                                   autofocus
                                   value="">
                        </div> -->
                    ...
                    <?php 
                        $str_arr = array();
                        $string = "INR,USD,EUR,AUD,YEN,CAD,PHP,SGD"; 
                    ...
                    ?>
                        ...
                        <div class="form-group">
                         ...
                         <select name="currency" id="currency" class="form-control" required autofocus>
                            ...
                            $client_currency = $this->mdl_clients->form_value('currency');
                            
                            
                            foreach ($str_arr as $key) { ?>
                    
                                    <option value="<?php echo $key; ?>"
                                        <?php check_select($client_currency, $key) ?>>
                                        <?php echo ($key); ?>
                                    </option>
                            <?php } ?>
                        </select>
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="panel panel-default client-ct">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" id="c_state" style="display:none;">
                            <label for="client_state"><?php _trans('state'); ?></label>

                            <div class="controls">
                                <input type="text" name="client_state" id="client_state1" class="form-control"
                                       value="<?php echo $this->mdl_clients->form_value('client_state', true); ?>">
                            </div>
                        </div>

                        <div class="form-group" id="client_new_state">
                            <label for="client_state"><?php _trans('state'); ?></label>
                            <div class="controls">
                                <select name="client_state" id="client_state" class="form-control client_state">
                                    <option value="">
                                    <?php _trans('none'); ?></option>
                            ...
                            foreach ($states_in as $key => $val) { ?>
                                <option value=" <?php echo $val; ?>"
                                 <?php check_select($key, $this->mdl_clients->form_value('client_state')) ?>>
                                    <?php echo $val; ?>
                                </option>
                            <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select name="client_country" id="client_country" class="form-control client_country">
...
<script>
    $(document).ready(function () {
        $('#client_country').on('change', function(){
        	...
        	if (value == 'IN') {
        	    $('#c_state').hide();
        	    $('#client_new_state').show();
        	} else {
        	    $('#c_state').show();
        	    $('#client_new_state').hide();
        	}
        });
        var state = $('#client_country').val();
        if(state =='IN') {
        	    $('#c_state').hide();
        	    $('#client_new_state').show();
        	} else {
