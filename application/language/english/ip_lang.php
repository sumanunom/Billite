...
$lang = array(
    ...
    'bcc_mails_to_admin_hint'                      => 'The admin account is the account that was created.',
    ...
    'default_tax_rate_inclusion'                   => 'Do you sell your lineitems at inclusive of Tax rates?',
    'delete'                                       => 'Delete',
    ...
    'invoice_pdf_include_zugferd_help'             => 'Enabling this option will include ZUGFeRD XML in invoice PDFs, which is an XML standard for invoices. <a href="https://go.billite.in/zugferdinfo">More information</a>',
    ...
    'loginalert_user_not_found'                    => 'This account cannot be found. Please use a different account to login.',
    'loginalert_wrong_auth_code'                   => 'Password reset denied. Please provide a valid authentication token.',
    'logout'                                       => 'Logout',
    ...
    'password_reset_email'                         => 'You requested a new password. Please click the following link to reset your password:',
    'password_reset_info'                          => 'You will get an Email with a link to reset your password.',
    'password_reset_failed'                        => 'An error occurred while trying to send your password reset email. Please enter your registered email address and try again.',
    'pay_now'                                      => 'Pay Now',
    'payment'                                      => 'Payment',
    ...
    'php_version_fail'                             => 'PHP version %s is installed but Billite requires PHP version %s or higher',
    'php_version_success'                          => 'PHP appears to meet the installation requirement',
    'please_enable_js'                             => 'Please enable Javascript to use Billite',
    'port'                                         => 'Port',
    'position'                                     => 'Position',
    'prefix'                                       => 'Prefix',
    'prev'                                         => 'Prev',
    ...
    'quotes_group'                                 => 'Choose your quote sequence pattern',
    ...
    'setup_complete_message'                       => 'Billite has been successfully installed. You may now log in.',
    'setup_complete_secure_setup'                  => 'If you want to secure your installation, you may disable the setup for now. To do so, replace the line <code>DISABLE_SETUP=false</code> with <code>DISABLE_SETUP=true</code> in your <code>config.php</code> file.',
    'setup_complete_support_note'                  => 'If you encounter any problems or you need help take a look at the <a href="https://wiki.billite.in">official wiki</a> or the <a href="https://community.billite.in/">community forum</a>.',
    'setup_create_user'                            => 'Create User Account',
    'setup_create_user_message'                    => 'This is the information you will need to log into Billite.',
    ...
    'setup_db_database_info'                       => 'The name of the database you created for Billite.',
    ...
    'setup_prerequisites_message'                  => 'Welcome to Billite! Any issue listed below must be resolved before the installation can continue.',
    ...
    'setup_user_email_info'                        => 'Your Email address will be used to log into Billite.',
    ...
    'setup_v120_alert'                             => '<strong>Attention!</strong><br>It\'s very important that you read <a href="https://go.billite.in/v120update" target="_blank">this update notice</a> about some significant changes of the Billite application.',
    'setup_v147_alert'                             => '<strong>Attention!</strong><br>Please open the file <code>application/config/config.php</code> and change the line <code>$config[\'sess_use_database\'] = false;</code> to <code>$config[\'sess_use_database\'] = true;</code>.<br>More details can be found <a href="https://go.billite.in/v147update" target="_blank">here</a>',
    ...
    'tax_inclusion'                                => 'Tax Inclusive',
    'tax_exclusion'                                => 'Tax Exclusive',
    'tax_rate'                                     => 'Tax Rate',
    ...
    'total_tax_or_item_tax'                        => 'Apply tax rate to each items or Total?',
    'try_again'                                    => 'Try Again',
    'type'                                         => 'Type',
    'unknown'                                      => 'Unknown',
    ...
    'tax_apply_items'                              => 'Apply Tax on Line Items',
    'tax_apply_total'                              => 'Apply Tax on Total',
    'accepted_date'                                => 'Accepted Data',
    'total_tax'                                    => 'Total Tax',
    'tax_total'                                    => 'Tax Total',
    'category'                                     => 'Category',
