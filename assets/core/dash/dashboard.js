    ...
    if ($("#performaneLine").length) {
      ...
      var salesTopData = {
          ...
          datasets: [{
            ...
            fill: true, // 3: no fill
            pointBorderWidth: 1,
            pointRadius: [3, 3, 3, 3, 3,3, 3, 3, 3, 3,3, 3, 3],
        ...
        tooltips: {
          callbacks: {
            ...
            label: function(tooltipItem, data) {
              var tlp_data = (data['datasets'][0]['data'][tooltipItem['index']]/total_invoiced[0]['total'])*100;
              var tlp_data_f = Math.round(tlp_data * 100) / 100; 
              return tlp_data_f+"%";
            }
          },
