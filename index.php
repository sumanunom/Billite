 ...
 * Make a copy of the config.php.example file, rename the copy to 'config.php' and set your settings in this file
 */
...
if (!file_exists('config.php')) {
    exit("The <b>config.php</b> file is missing! Please make a copy of the <b>config.php.example</b> file and rename it to <b>config.php</b>");
}
...
define('IPCONFIG_FILE', FCPATH . 'config.php');
